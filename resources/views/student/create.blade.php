                        ...
                        <div class="offset-xl-2 col-xl-8 col-12">
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="card mb-4">
                                    <!-- card body -->
                                    <div class="card-body">
                                        <h2 class="mb-4 text-secondary">Créer un élève</h2>
                                        ...
                                        <div class="row gx-3">
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entrez le nom de l'élève" id="firstName" name="firstName" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entrez le prénom de l'élève" id="lastName" name="lastName" required>
                                            ...
                                            <label class="form-label" for="birthday">Date de naissance</label>
                                                <input type="date" class="form-control" placeholder="Entrez le prénom de l'élève" id="birthday" name="birthday" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entrez le lieu de naissance de l'élève" id="birthPlace" name="birthPlace" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Entrez le matricule de l'élève" id="matricule" name="matricule" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entrez le nom complet du père" id="FatherName" name="FatherName" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Entrez le numero de téléphone du père" id="fatherPhone" name="fatherPhone" required>
                                             ...
                                             <div class="mb-5 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entrez le nom complet du père" id="motherName" name="motherName" required>
                                            ...
                                            <div class="mb-5 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Entrez le numero de téléphone du père" id="motherPhone" name="motherPhone" required>
