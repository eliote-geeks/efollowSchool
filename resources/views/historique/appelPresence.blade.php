                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center">
                            <h2 class="mb-1">Gestion des présences</h2>
                            <div class="ms-auto">
                            </div>
                        </div>
                        <p class="mb-0">
                            Sur cette page vous pouvez consulter l'historique des présences ainsi que générer des rapports
                        </p>
                    </div>
                    <!-- table  -->
                    <div class="card-body">

                        <h3 class="mb-3 me-auto text-secondary">Générer un rapport de présence</b></h3>
