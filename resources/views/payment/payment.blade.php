...
<x-layouts>
    <div class="container mt-5">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <p><strong>Classe :</strong> {{ $student->studentClasse->classe->niveau->name.' '.$student->studentClasse->classe->name }}</p>
            </div>
        </div>
        ...
        <form action="{{ route('payment.store') }}" method="POST" class="mt-4">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".payment-confirmation-modal">
                Confirmation de paiement
            </button>

            <!-- Modal de Confirmation -->
            <div class="modal fade payment-confirmation-modal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true">
    ...
    <script>
        document.querySelector('[data-bs-target=".payment-confirmation-modal"]').addEventListener('click', function () {
            ...
            const tranche = document.getElementById('scolarite_id').options[document.getElementById('scolarite_id').selectedIndex].text;
