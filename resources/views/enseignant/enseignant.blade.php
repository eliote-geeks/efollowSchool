...
<x-layouts>
                    ...
                    <div class="card-header">
                         <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary rounded-pill ms-auto" data-bs-toggle="modal" 
                                href="#addProfesseur" role="button">
                        ...
                        <div class="table-card">
                            <table id="dataTableBasic" class="table table-hover align-middle table-responsive"
                                ...
                                <tbody>
                                    ...
                                    <div class="modal fade" id="editProfesseur" aria-hidden="true"
                                        aria-labelledby="editProfesseur" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h3 class="modal-title" id="editProfesseurLabel">Modifier
                                                        les informations du professeur <b>NOM_DU_PROFESSEUR</b></h3>
    ...
    <div class="modal fade" id="addProfesseur" aria-hidden="true"
        aria-labelledby="addProfesseur" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
